...
import com.xwke.api.audit.AuditConnector;
import com.xwke.api.audit.AuditDTO;
import com.xwke.security.LoginEvent;
...
public class SpringSecurityListener implements ApplicationListener, ApplicationContextAware {
	...
	public void logLoginSuccess(ApplicationEvent event) throws Exception {
		...
		if (principal instanceof SpringSecurityUserAuth) {
			userId = ((SpringSecurityUserAuth) principal).getTenantId();
		} else {
		...
		ctx.publishEvent(new LoginEvent(authentication, userId, this.getSessionId(authentication), "success", "default",
				tenantId));
	}
	...
	public void logBadCredential(ApplicationEvent event) throws Exception {
		...
		ctx.publishEvent(new LoginEvent(authentication, userId, this.getSessionId(authentication), "badCredentials",
				"default", tenantId));
	}
	...
	public void logLocked(ApplicationEvent event) throws Exception {
		...
		ctx.publishEvent(new LoginEvent(authentication, userId, this.getSessionId(authentication), "locked", "default",
				tenantId));
	}
	...
	public void logDisabled(ApplicationEvent event) throws Exception {
		...
		ctx.publishEvent(new LoginEvent(authentication, userId, this.getSessionId(authentication), "disabled",
				"default", tenantId));
	}
	...
	public void logCredentialExpired(ApplicationEvent event) throws Exception {
		...
		ctx.publishEvent(new LoginEvent(authentication, userId, this.getSessionId(authentication), "credentialExpired",
				"default", tenantId));
	}
	...
	public void logAccountExpired(ApplicationEvent event) throws Exception {
		...
		ctx.publishEvent(new LoginEvent(authentication, userId, this.getSessionId(authentication), "accountExpired",
				"default", tenantId));
	}
