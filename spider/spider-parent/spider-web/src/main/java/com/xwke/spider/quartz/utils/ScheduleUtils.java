package com.xwke.spider.quartz.utils;
...
public class ScheduleUtils {
	 ...
	 *            the schedule job
	 */
	public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob, Class<? extends Job> jobClass) {
	...
	public static void createScheduleJob(Scheduler scheduler, String jobName, String jobGroup, String cronExpression,
			Class<? extends Job> jobClass, Object param) {
		// 同步或异步
