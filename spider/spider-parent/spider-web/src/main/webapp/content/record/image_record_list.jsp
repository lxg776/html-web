...
<script type="text/javascript">
	var listUrl="${ctx}"+"/record/imagesList?pageNum=";
						...
						<table class="table table-bordered">
							<thead>
								<tr>
									...
									<th style="width: 200px;">图片地址</th>
									<th style="width: 200px;">保存路径</th>
							...
							<tbody>
								<c:forEach var="item" items="${page.dataList}" >
									<tr>
									<td>${item.id}</td>
									<td class="center">${item.imageUrl}</td>
									<td class="center">${item.savePath}</td>
